...
class spi_data_t(object):
    __slots__ = ["q_abad", "q_hip", "q_knee", "qd_abad", "qd_hip", "qd_knee", "flags", "spi_driver_status", "tau_abad", "tau_hip", "tau_knee", "tmp_abad", "tmp_hip", "tmp_knee", "reserve"]

    __typenames__ = ["float", "float", "float", "float", "float", "float", "int32_t", "int32_t", "float", "float", "float", "int16_t", "int16_t", "int16_t", "int8_t"]

    __dimensions__ = [[4], [4], [4], [4], [4], [4], [12], None, [4], [4], [4], [4], [4], [4], [40]]
    ...
    def __init__(self):
        ...
        self.tmp_abad = [ 0 for dim0 in range(4) ]
        self.tmp_hip = [ 0 for dim0 in range(4) ]
        self.tmp_knee = [ 0 for dim0 in range(4) ]
        self.reserve = [ 0 for dim0 in range(40) ]
    ...
    def _encode_one(self, buf):
        ...
        buf.write(struct.pack('>4h', *self.tmp_abad[:4]))
        buf.write(struct.pack('>4h', *self.tmp_hip[:4]))
        buf.write(struct.pack('>4h', *self.tmp_knee[:4]))
        buf.write(struct.pack('>40b', *self.reserve[:40]))
    ...
    def _decode_one(buf):
        ...
        self.tmp_abad = struct.unpack('>4h', buf.read(8))
        self.tmp_hip = struct.unpack('>4h', buf.read(8))
        self.tmp_knee = struct.unpack('>4h', buf.read(8))
        self.reserve = struct.unpack('>40b', buf.read(40))
        return self
    _decode_one = staticmethod(_decode_one)

    def _get_hash_recursive(parents):
        if spi_data_t in parents: return 0
        tmphash = (0x4da50a8960be7463) & 0xffffffffffffffff
